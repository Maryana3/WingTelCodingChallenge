    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ONE_KILOBYTE_PRICE', models.DecimalField(decimal_places=10, default='0.0015', max_digits=20)),
                ('ONE_SECOND_PRICE', models.DecimalField(decimal_places=10, default='0.0015', max_digits=20)),
                ('subscription_type', models.CharField(default='', max_length=20)),
